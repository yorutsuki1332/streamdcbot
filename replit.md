...
- July 08, 2025. Updated button icon with improved unicorn character image (cleaner background)
- July 08, 2025. Resized button icon to maximum Discord emoji size (128x128px) for better visibility